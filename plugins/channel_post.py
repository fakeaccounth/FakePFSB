...
@Bot.on_message(filters.private & filters.user(ADMINS) & ~filters.command(['start', 'users', 'broadcast', 'batch', 'genlink', 'stats', 'total', 'clear']))
async def channel_post(client: Client, message: Message):
    ...
    website_link = f"{WEBSITE_URL}?NC={base64_string}" if WEBSITE_URL_MODE else None
